...
(function(){ //Executes function for code
   ...
   var playerOne = ["Jason_Brody", 20, 100]; //Array for player one
   var playerTwo = ["Vaas_Montenegro", 20, 100]; //Array for player two

   var round = 1; //Variable for each round

 function fight(){ //Executes function for fight
   console.log("FIGHT!!!"); //Displays the message "FIGHT!!!" to the console
 ...
 function winnerCheck() { //Executes function for the winner check
    var results = "No winner"; //Variable for the message "No winner"
